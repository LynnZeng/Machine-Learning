...
Xtrn = pd.read_csv("X-trn-200.csv")
Ytrn = pd.read_csv("Y-trn-200.csv")
Xtst = pd.read_csv("X-tst-200.csv")
Ytst = pd.read_csv("Y-tst-200.csv")
TrnAc_Entr=list(xrange(2,16))
TstAc_Entr=list(xrange(2,16))
TrnAc_Gini=list(xrange(2,16))
TstAc_Gini=list(xrange(2,16))
for i in range(2,16):
